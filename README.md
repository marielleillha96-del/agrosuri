...
- `https://github.com/marielleillha96-del/agrosuri`
...
- `APP_ENV`: `production`
- `PORT`: `3000`
- `APP_URL`: `https://agrosuri.com.br`
- `APP_DOMAIN`: `agrosuri.com.br`
- `CORS_ORIGIN`: `https://agrosuri.com.br,https://www.agrosuri.com.br`
...
1. Importe o repositório `marielleillha96-del/agrosuri`
